...
namespace GameWIndowTest1.Abilities
{
    public class ability
    {
        ...
        public Ability_type ability_Type { get; protected set; }

        /*          Critical Hit Values         */
        public int critical_hit_percentage { get; protected set; }
        public int critical_hit_bonus { get; protected set; }

        /*          Missing Values              */
        public int missing_percentage { get; protected set; }
